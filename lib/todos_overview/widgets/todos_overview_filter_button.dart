...
class TodosOverviewFilterButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocSelector<TodosOverviewBloc, TodosOverviewState, TodosViewFilter>(
      ...
      builder: (context, activeFilter) {
        return PopupMenuButton<TodosViewFilter>(
          ...
          itemBuilder: (context) {
            return [
              PopupMenuItem(value: TodosViewFilter.all, child: Text(l10n.todosOverviewFilterAll)),
              PopupMenuItem(
